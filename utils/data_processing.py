...
class Preprocess_Module:
    ...
    def __init__(self, data_augmentation, norm_mode = 'auto'):
        self.transforms = []
        self.transforms.append(PreNormalize2D(img_shape=(320, 480), mode = norm_mode, threshold=0.01, data_augmentation=data_augmentation))
